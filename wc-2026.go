...
func grupoA() []*grupoPos {
	...
	elo["Mexico"] = 1912
	elo["South Africa"] = 1575
	elo["South Korea"] = 1723
	elo["Czech Republic"] = 1680
...
func grupoB() []*grupoPos {
	...
	elo["Canada"] = 1748
	elo["Bosnia and Herzegovina"] = 1622
	elo["Qatar"] = 1411
	elo["Switzerland"] = 1914
	...
	// ordenarGrupo(pos)
	pos = []*grupoPos{pos[3], pos[0], pos[1], pos[2]}
	resultadosGrupo(pos)
...
func grupoC() []*grupoPos {
	...
	// ordenarGrupo(pos)
	pos = []*grupoPos{pos[0], pos[1], pos[3], pos[2]}
	resultadosGrupo(pos)
...
func grupoI() []*grupoPos {
	...
	// ordenarGrupo(pos)
	pos = []*grupoPos{pos[0], pos[3], pos[1], pos[2]}
	resultadosGrupo(pos)
