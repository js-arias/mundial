...
func grupoE() (e1, e2 string) {
	pos := []*grupoPos{
		{nombre: "España", suerte: rand.Float64()},
		{nombre: "Costa Rica", suerte: rand.Float64()},
		{nombre: "Alemania", suerte: rand.Float64()},
		{nombre: "Japón", suerte: rand.Float64()},
	}
...
func grupoF() (f1, f2 string) {
	pos := []*grupoPos{
		{nombre: "Bélgica", suerte: rand.Float64()},
		{nombre: "Canadá", suerte: rand.Float64()},
		{nombre: "Marruecos", suerte: rand.Float64()},
		{nombre: "Croacia", suerte: rand.Float64()},
	}
...
func grupoG() (g1, g2 string) {
	pos := []*grupoPos{
		{nombre: "Brasil", suerte: rand.Float64()},
		{nombre: "Serbia", suerte: rand.Float64()},
		{nombre: "Suiza", suerte: rand.Float64()},
		{nombre: "Camerún", suerte: rand.Float64()},
	}
...
func grupoH() (g1, g2 string) {
	pos := []*grupoPos{
		{nombre: "Portugal", suerte: rand.Float64()},
		{nombre: "Ghana", suerte: rand.Float64()},
		{nombre: "Uruguay", suerte: rand.Float64()},
		{nombre: "Corea del Sur", suerte: rand.Float64()},
	}
